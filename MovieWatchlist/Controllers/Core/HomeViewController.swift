...
class HomeViewController: UIViewController {
    ...
    private func configureNavBar() {
        var image = UIImage(systemName: "play.fill")
        image = image?.withRenderingMode(.alwaysOriginal).withTintColor(UIColor(red: 234/255, green: 29/255, blue: 36/255, alpha: 1))
        let barButtonItem = UIBarButtonItem(image: image, style: .done, target: self, action: nil)
        
        navigationItem.leftBarButtonItem = barButtonItem
        navigationItem.rightBarButtonItem =
        UIBarButtonItem(image: UIImage(systemName: "person.fill")?.withRenderingMode(.alwaysOriginal).withTintColor(UIColor(red: 234/255, green: 29/255, blue: 36/255, alpha: 1)), style: .done, target: self, action: nil)
